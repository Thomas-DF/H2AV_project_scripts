...
H2AV_pol2_nelf = import(H2AV_pol2_nelf_file)
H2AV_pol2_wt = import(H2AV_pol2_wt_file)
...
for(GR in GR_list_toPlot_peaks){
  seqPlotSDoutliers_scaleFact(c(H2AV_pol2_nelf_file,H2AV_pol2_wt_file),tmp,GR,c(0,3),c(0,5000),type="pf",bin=10,
