...
outfig = paste0(workdir,"FIGURES/BOXPLOT/BOXPLOT_Q_H2AV_H3K36m3/")
...
names(Q_GB_SEA4_NELFKD_R3_f) <- paste0(names(Q_GB_SEA4_NELFKD_R3_f), ".1")
names(Q_GB_SEA4_WT_R3_f) <- paste0(names(Q_GB_SEA4_WT_R3_f), ".1")

names(Q_GB_WT3_NELFKD_R3_f) <- paste0(names(Q_GB_WT3_NELFKD_R3_f), ".1")
names(Q_GB_WT3_WT_R3_f) <- paste0(names(Q_GB_WT3_WT_R3_f), ".1")
...
getRandomNameList = function(Vec, prct = 10){
  s = length(Vec)/(100/prct)
  GN = sample(x = Vec, size = s+1)
  GN = names(GN)
  return(GN)
}
...
CTRL5_ZSCORE_H3K36me3_2C4_vs_2N4 = ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f[(len*0.6) : (len*0.65)]
...
RANDOM5_ZSCORE_H3K36me3_2C4_vs_2N4 = getRandomNameList(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f, prct = 5)
...
LIST_UP_DN_H3K36me3=list(
  DN10_Q_H3K36me3_2C4=DN10_Q_H3K36me3_2C4,
  delta_UP10_Q_H3K36me3_2C4=UP10_Q_H3K36me3_2C4
)
...
LIST_5_UP_RANDOM_ZSCORE_H3K36me3_2C4_vs_2N4=list(
  DN5_H3K36me3_2C4_vs_2N4=DN5_ZSCORE_H3K36me3_2C4_vs_2N4,
  RANDOM5_H3K36me3_2C4_vs_2N4 = RANDOM5_ZSCORE_H3K36me3_2C4_vs_2N4,
...
Boxplot_wilcoxListFilter_REF(quantifWT = Q_H2AV_SEA4_LucKD, quantifKD = Q_H2AV_SEA4_NelfKD, cond1 = "Q_H2AV_SEA4_LucKD", cond2="Q_H2AV_SEA4_NelfKD", filterGNList = LIST_UP_DN_H3K36me3,
                             effMin =500,  SampleNorm = c(F, "NULL"),YLIM =NULL, bxplt_color = c("#285bad", "#eb3434"), outlierTH = 0.01, logTrans=T,
                             outdir = outfig, readQuantif = "Q_H2AV_SEA4_LucKD", Cond = "Q_H2AV_SEA4_NelfKD", select = "LIST_UP_DN_H3K36me3", info = NULL)

## WT3 : Luc KD / Nelf KD

Boxplot_wilcoxListFilter_REF(quantifWT = Q_H2AV_WT3_LucKD, quantifKD = Q_H2AV_WT3_NelfKD, cond1 = "Q_H2AV_WT3_LucKD", cond2="Q_H2AV_WT3_NelfKD", filterGNList = LIST_UP_DN_H3K36me3,
                             effMin =500,  SampleNorm = c(F, "NULL"),YLIM =NULL, bxplt_color = c("#285bad", "#eb3434"), outlierTH = 0.01, logTrans=T,
                             outdir = outfig, readQuantif = "Q_H2AV_WT3_LucKD", Cond = "Q_H2AV_WT3_NelfKD", select = "LIST_UP_DN_H3K36me3", info = NULL)
...
Boxplot_wilcoxListFilter_REF(quantifWT = Q_GB_SEA4_WT_R3_f, quantifKD = Q_GB_SEA4_NELFKD_R3_f, cond1 = "Q_GB_SEA4_WT_R3_f", cond2="Q_GB_SEA4_NELFKD_R3_f", filterGNList = LIST_UP_DN_H3K36me3,
                             effMin =500,  SampleNorm = c(F, "NULL"),YLIM =NULL, bxplt_color = c("#285bad", "#eb3434"), outlierTH = 0.01, logTrans=T,
                             outdir = outfig_R3, readQuantif = "Q_GB_SEA4_WT_R3_f", Cond = "Q_GB_SEA4_NELFKD_R3_f", select = "LIST_UP_DN_H3K36me3", info = NULL)

## WT3 : Luc KD / Nelf KD

Boxplot_wilcoxListFilter_REF(quantifWT = Q_GB_WT3_WT_R3_f, quantifKD = Q_GB_WT3_NELFKD_R3_f, cond1 = "Q_GB_WT3_WT_R3_f", cond2="Q_GB_WT3_NELFKD_R3_f", filterGNList = LIST_UP_DN_H3K36me3,
                             effMin =500,  SampleNorm = c(F, "NULL"),YLIM =NULL, bxplt_color = c("#285bad", "#eb3434"), outlierTH = 0.01, logTrans=T,
                             outdir = outfig_R3, readQuantif = "Q_GB_WT3_WT_R3_f", Cond = "Q_GB_WT3_NELFKD_R3_f", select = "LIST_UP_DN_H3K36me3", info = NULL)





### LIST_UP_DN_ZSCORE_H3K36me3_2C4_vs_2N4

### REPLICATS 2, TOP / BOT 5%
...
### REPLICATS 2, TOP / BOT / RANDOM 5%

## SEA4 : Luc KD / Nelf KD

Boxplot_wilcoxListFilter_REF(quantifWT = Q_H2AV_SEA4_LucKD, quantifKD = Q_H2AV_SEA4_NelfKD, cond1 = "Q_H2AV_SEA4_LucKD", cond2="Q_H2AV_SEA4_NelfKD", filterGNList = LIST_5_UP_RANDOM_ZSCORE_H3K36me3_2C4_vs_2N4,
                             effMin =500,  SampleNorm = c(F, "NULL"),YLIM =NULL, bxplt_color = c("#285bad", "#eb3434"), outlierTH = 0.01, logTrans=T,
                             outdir = outfig, readQuantif = "Q_H2AV_SEA4_LucKD", Cond = "Q_H2AV_SEA4_NelfKD", select = "LIST_5_UP_RANDOM_ZSCORE_H3K36me3_2C4_vs_2N4", info = NULL)

## WT3 : Luc KD / Nelf KD

Boxplot_wilcoxListFilter_REF(quantifWT = Q_H2AV_WT3_LucKD, quantifKD = Q_H2AV_WT3_NelfKD, cond1 = "Q_H2AV_WT3_LucKD", cond2="Q_H2AV_WT3_NelfKD", filterGNList = LIST_5_UP_RANDOM_ZSCORE_H3K36me3_2C4_vs_2N4,
                             effMin =500,  SampleNorm = c(F, "NULL"),YLIM =NULL, bxplt_color = c("#285bad", "#eb3434"), outlierTH = 0.01, logTrans=T,
                             outdir = outfig, readQuantif = "Q_H2AV_WT3_LucKD", Cond = "Q_H2AV_WT3_NelfKD", select = "LIST_5_UP_RANDOM_ZSCORE_H3K36me3_2C4_vs_2N4", info = NULL)
