...
## SEA4 condition  - AVERAGE PLOT

pdf(paste0(workdir,"FIGURES/AVG_PROF/RAD51_SEA4_WT3/AVG_PROF_SEA4_Rad51_H3K36me3_2C4.pdf"))
...
## WT3 condition  - AVERAGE PLOT

pdf(paste0(workdir,"FIGURES/AVG_PROF/RAD51_SEA4_WT3/AVG_PROF_WT3_Rad51_H3K36me3_2C4.pdf"))
for(GR in GR_list_toPlot_H3K36me3){
