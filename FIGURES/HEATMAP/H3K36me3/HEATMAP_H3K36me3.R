...
heatMatrixMat(ChIP_H3K36me3_FSEA4_Luc_profmat[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="ChIP_H3K36me3_FSEA4_Luc_profmat",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()

pdf(paste0(outfig, "ChIP_H3K36me3_FSEA4_Nelf_profmat","_BY_","ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f",".pdf"))
heatMatrixMat(ChIP_H3K36me3_FSEA4_Nelf_profmat[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="ChIP_H3K36me3_FSEA4_Nelf_profmat",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()
...
heatMatrixMat(ChIP_H3K36me3_FWT3_Luc_profmat[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="ChIP_H3K36me3_FWT3_Luc_profmat",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()

pdf(paste0(outfig, "ChIP_H3K36me3_FWT3_Nelf_profmat","_BY_","ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f",".pdf"))
heatMatrixMat(ChIP_H3K36me3_FWT3_Nelf_profmat[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="ChIP_H3K36me3_FWT3_Nelf_profmat",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()
...
heatMatrixMat(DRIP_HLuc_profmat[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="DRIP_HLuc_profmat",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()

pdf(paste0(outfig, "DRIP_HLuc_RNAse_profmat","_BY_","ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f",".pdf"))
heatMatrixMat(DRIP_HLuc_RNAse_profmat[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="DRIP_HLuc_RNAse_profmat",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()
...
heatMatrixMat(DRIP_Nelf_profmat[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="DRIP_Nelf_profmat",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()
...
heatMatrixMat(DRIP_HypB_profmat[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="DRIP_HypB_profmat",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()

pdf(paste0(outfig, "DRIP_HypB_RNAse_profmat","_BY_","ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f",".pdf"))
heatMatrixMat(DRIP_HypB_RNAse_profmat[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="DRIP_HypB_RNAse_profmat",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()
...
heatMatrixMat(ZSCORE_PROFMAT_DRIP_HLuc_vs_HLuc_RNAse[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="ZSCORE_PROFMAT_DRIP_HLuc_vs_HLuc_RNAse",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()

pdf(paste0(outfig, "ZSCORE_PROFMAT_DRIP_Nelf_vs_Nelf_RNAse","_BY_","ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f",".pdf"))
heatMatrixMat(ZSCORE_PROFMAT_DRIP_Nelf_vs_Nelf_RNAse[names(ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f),rangeheatmap],winsorize=c(5,95), order = TRUE, main="ZSCORE_PROFMAT_DRIP_Nelf_vs_Nelf_RNAse",legend.name="ZSCORE_H3K36me3_2C4_H3K36me3_2N4_f")        
dev.off()
