...
#source(paste0(workdir, "functionR/FisherList_Hmap_GNlist_vs_GNlist.R"))

# exemple of liste function 
#liste_Qart_bord_TAD_L=
#    list(
#    TAD_Q1_K36_L=vec_TAD_Q1_L,
#    TAD_Q2_K36_L=vec_TAD_Q2_L,
#    TAD_Q3_K36_L=vec_TAD_Q3_L,
#    TAD_Q4_K36_L=vec_TAD_Q4_L)

#liste_Qart_bord_TAD_R=
#    list(
#    TAD_Q1_k36_R=vec_TAD_Q1_R,
#    TAD_Q2_k36_R=vec_TAD_Q2_R,
#    TAD_Q3_k36_R=vec_TAD_Q3_R,
#    TAD_Q4_k36_R=vec_TAD_Q4_R)
...
Hmap_pval=function(mat,graph,threshold=1e-8, odds_scale = c(0,2)){
   pdf(graph) # should we plot in pdf -> yes if bool = T
   # Prepare pval matrix
   mat_pv=mat$p.value
   ...
   rownames(pval_info) = c("white", "purple")
   textplot(pval_info)
  ...
  v_cols = c(colorRampPalette(c("purple", "white"))(24), "white", colorRampPalette(c("white", "white"))(24))
 ...
 textplot(mat$odds.ratio) # PLOT ODDS RATIO TABLE
    ...
    v_cols = c(colorRampPalette(c("yellow", "white"))(24), "white", colorRampPalette(c("white", "purple"))(24))
    ...
    #v_cols = c(colorRampPalette(c("yellow", "white"))(24), "white", colorRampPalette(c("white", "darkgreen"))(24))
